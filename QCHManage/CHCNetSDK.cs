...
namespace QCHManage
{
    public class CHCNetSDK
    {
        ...
        **********************************************************/
        ...
        //public static void  NET_DVR_CapturePicture(Int32 lRealHandle, string sPicFileName);


        //[DllImport(@"HCNetSDK.dll")]
        //public static extern Image Net_DVR_GetImage(Int32 lRealHandle, string sPicFileName);
